...
<div id="view-fame" style="padding:16px;display:none;">
  ...
  <div style="margin-top:16px;padding:14px;background:rgba(56,0,60,0.4);border-radius:6px;font-family:monospace;font-size:11px;color:#8060a0;line-height:2;">
    ...
    <div style="display:grid;grid-template-columns:30px 1fr 50px 50px;gap:4px;padding:4px 0;border-top:1px solid #2a0a3a;"><div>8</div><div>Herbz</div><div style="text-align:center;">—</div><div style="text-align:center;">—</div></div>
  </div>
</div>
